<footer style="background-color: #ffffff; border-top: 1px solid #ffffff; margin-top: 10px;">
    <div class="footer clearfix mb-0 text-muted">
        <div class="float-start">
            <p style="color: #333;">2023 &copy; Polinema Kediri</p>
        </div>
{{--         <div class="float-end">
            <p style="color: #555; border-left: 1px solid #ddd; padding-left: 10px;">Arsip</p>
        </div> --}}
    </div>
</footer>
</div>
